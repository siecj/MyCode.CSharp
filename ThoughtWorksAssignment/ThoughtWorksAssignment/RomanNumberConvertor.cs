...
namespace ThoughtWorksAssignment
{
    ...
    public class RomanNumberConvertor : IArabicConvertable
    {
        public int ConvertToArabic(string number)
        {
            ...
            while (true)
            {
                if (counter == number.Length)
                    break;
                int tmp = ConvertSingleRomanToArabic(number[counter].ToString());
        ...
        public int ConvertSingleRomanToArabic(string roman)
        {
